...
```bash
# 1. Generate the itch.io HTML5 ZIP bundle (outputs itemseed-v<version>.zip, e.g. itemseed-v1.0.1.zip):
...
| :--- | :--- | :--- |
| **HTML5 Package** | `itemseed-v1.0.1.zip` (or `itemseed-v<version>.zip`) | Uploaded in **Uploads** section with *"This file will be played in the browser"* checked. |
...
- [ ] **Step 1: Build Package**: Run `npm run package:itch` in terminal to produce `itemseed-v<version>.zip` (e.g. `itemseed-v1.0.1.zip`).
- [ ] **Step 2: Upload Archive**: In itch.io project dashboard, upload `itemseed-v1.0.1.zip` and check *"This file will be played in the browser"* (and set the version tag to `v1.0.1`).
